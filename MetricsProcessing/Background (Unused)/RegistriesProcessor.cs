...
namespace MetricsProcessing
{
    ...
    public class RegistriesProcessor
    {
        ...
        /// </exception>
        protected RegistriesList GetRegistries(int registriesToProcessAtOnce)
        {
            try
            {
        ...
        /// </returns>
        protected static int DetectActivity(RegistriesList registries)
        {
            int count = 1;
        ...
        /// </summary>
        protected static RegistriesList ExtractActivity(RegistriesList fromRegistries, int count)
        {
        ...
        protected void MarkAsProcessed(List<Registry> registries)
        {
        ...
        /// </summary>
        protected void MarkAsShouldNotBeProcessed(Registry registry)
        {
